...
class Job(BaseModel):
    ...
    country = models.CharField(max_length=60, choices=NATIONALITY_CHOICES, default="Indian")
    college = models.CharField(max_length=128)
    department = models.CharField(max_length=128)
    passout = models.CharField(max_length=128, choices=PASSOUT_CHOICES, default="2022")
    role = models.CharField(max_length=128, choices=ROLE_CHOICES, default="Devoloper")
...
class Country(BaseModel):
    contry = models.ForeignKey(Job, related_name="applied_country", on_delete=models.CASCADE)
...
class State(BaseModel):
    state = models.ForeignKey(Job, related_name="applied_state", on_delete=models.CASCADE)
