...
urlpatterns = [
    ...
    path('pages/samples/error-404.html/', TemplateView.as_view(template_name="app/pages/samples/error-404.html")),
    path('pages/samples/error-500.html/', TemplateView.as_view(template_name="app/pages/samples/error-500.html")),
    path('pages/samples/login.html/', TemplateView.as_view(template_name="app/pages/samples/login.html")),
    path('pages/samples/register.html/', TemplateView.as_view(template_name="app/pages/samples/register.html")),
